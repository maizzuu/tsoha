...
CREATE TABLE swap (id SERIAL PRIMARY KEY, date DATE, start_time TEXT, end_time TEXT, post TEXT, comment TEXT, username TEXT REFERENCES users(username), visibility INTEGER);
CREATE TABLE take (id SERIAL PRIMARY KEY, date DATE, start_time TEXT, end_time TEXT, post TEXT, comment TEXT, username TEXT REFERENCES users(username), visibility INTEGER);
CREATE TABLE give (id SERIAL PRIMARY KEY, date DATE, comment TEXT, username TEXT REFERENCES users(username), visibility INTEGER);
